...
class Agent():
    ...
    def step(self, learn, m_ob, o_ob, m_action, o_action, m_next_ob, o_next_ob, m_reward, o_reward, m_d, o_d ):
        ...
        # next_states = [m_next_ob, o_next_ob]
        # rewards = [m_reward, o_reward]
        # dones = [m_d, o_d]
    ...
    def learn(self, experiences, gamma):
        ...
        m_obs, o_obs, m_actions, o_actions, m_next_obs, o_next_obs, m_rewards, o_rewards, m_ds, o_ds = experiences
        # ---------------------------- update critic ---------------------------- #
...
class ReplayBuffer:
    ...
    def __init__(self, action_size, buffer_size, batch_size, seed):
        ...
        self.experience = namedtuple("Experience", field_names=["state","state1", "action","action1", "reward","reward1", "next_state", "next_state1","done", "done1"])
        self.seed = random.seed(seed)
    
    # def step(self, m_ob, o_ob, m_action, o_action, m_next_ob, o_next_ob, m_reward, o_reward, m_d, o_d ):
    
    def add(self, m_ob, o_ob, m_action, o_action, m_next_ob, o_next_ob, m_reward, o_reward, m_d, o_d):
        """Add a new experience to memory."""
        e = self.experience(m_ob, o_ob, m_action, o_action, m_next_ob, o_next_ob, m_reward, o_reward, m_d, o_d)
    ...
    def sample(self):
        ...
        return (states,states1, actions, actions1, rewards,rewards1, next_states,next_states1, dones, dones1)
